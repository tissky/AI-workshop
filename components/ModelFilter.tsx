...
export default function ModelFilter({ categories, models }: ModelFilterProps) {
    ...
    <>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredModels.map((model) => (
          <div
            key={model.id}
            className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all group border border-gray-100"
          >
